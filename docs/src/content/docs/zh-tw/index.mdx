...
<CardGrid stagger>
	...
	<Card title="一份來源，多種出版輸出" icon="document">
		`renderHtml`、包含 note 的六種 `renderTextFormat`、`renderEpub`、`renderDocx`，以及透過 Chromium 的 Rust PDF 都已實作。詳見[輸出格式](/zh-tw/ecosystem/outputs/)。
	</Card>
