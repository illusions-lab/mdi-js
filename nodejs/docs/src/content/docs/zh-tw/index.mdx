...
<CardGrid stagger>
	...
	<Card title="誠實而精簡的語言介面" icon="puzzle">
		JavaScript/TypeScript、Rust 與 Python（`pip install illusion-markdown`）已可使用，且都呼叫同一個 Rust core。Swift 明確標示為 **Planned**，沒有虛構的安裝方式。需要 unified 管線時可用 remark adapter 取得 mdast。
	</Card>
